...
# Test LLM import
./result-vllm-python313-cuda12_9-sm90-avx512/bin/python -c "from vllm import LLM; print('OK')"

# Publish to catalog
flox publish vllm-python313-cuda12_9-sm90-avx512
```
...
3. Builds vLLM from the custom package set via `python313Custom.pkgs.vllm`
...
| `vllm-0.14.0` | 0.14.0 | `46336d4` | 2.9.1 | 3.12 |
...
```nix
# vLLM 0.15.1 for NVIDIA Hopper (SM90: H100, H200, L40S) — AVX-512
