...
```
vllm-python312-cuda12_9-sm{XX}-{isa}.nix
```
...
Examples:
- `vllm-python312-cuda12_9-sm90-avx512.nix` (H100, x86_64, AVX-512)
...
- `vllm-python312-cuda12_9-sm90-armv8_2.nix` (H100 PCIe in Ampere Altra, aarch64, ARMv8.2)
- `vllm-python312-cuda12_9-sm103-armv9.nix` (Grace Blackwell Ultra GB300, aarch64, ARMv9)
...
**Total: 52 variants** (47 x86_64 + 5 aarch64), all Python 3.12.
