# vLLM 0.15.1 for NVIDIA Turing (SM75: T4, RTX 2080 Ti) — AVX-512 VNNI
...
let
  ...
  smCapability = "7.5";
  variantName = "vllm-python313-cuda12_8-sm75-avx512vnni";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA T4/RTX 2080 Ti (SM75) [CUDA 12.8, custom PyTorch AVX-512 VNNI]";
      platforms = [ platform ];
    };
  })
