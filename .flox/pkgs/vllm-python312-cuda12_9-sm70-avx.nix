# vLLM 0.14.0 for NVIDIA Volta (SM70: V100, Titan V) — AVX
...
let
  ...
  smCapability = "7.0";
  variantName = "vllm-python312-cuda12_9-sm70-avx";
...
in
  python312Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA V100/Titan V (SM70) [CUDA 12.9, custom PyTorch AVX]";
      platforms = [ platform ];
    };
  })
