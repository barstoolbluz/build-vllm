# vLLM 0.14.0 for NVIDIA Blackwell DC (SM100: B100, B200, GB200)
...
let
  ...
  smCapability = "10.0";
  variantName = "vllm-python312-cuda12_9-sm100";
  # ────────────────────────────────────────────────────────────────────
in
  nixpkgs_pinned.python312Packages.vllm.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA B100/B200/GB200 (SM100) [CUDA 12.9]";
