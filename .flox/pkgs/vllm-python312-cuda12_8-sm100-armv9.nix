# vLLM 0.14.1 for NVIDIA Grace Blackwell (SM100: GB200) — ARMv9
...
let
  ...
  smCapability = "10.0";
  variantName = "vllm-python312-cuda12_8-sm100-armv9";
...
in
  python312Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.1 for NVIDIA Grace Blackwell GB200 (SM100) [CUDA 12.8, custom PyTorch ARMv9]";
      platforms = [ platform ];
    };
  })
