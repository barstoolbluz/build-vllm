# vLLM 0.14.0 for NVIDIA Volta (SM70: V100, Titan V) — AVX-512 BF16
# CUDA 12.9 — Requires NVIDIA driver 560+
# Custom PyTorch 2.9.1 built from source (SM70 + AVX-512 BF16)
{ pkgs ? import <nixpkgs> {} }:
let
  ...
  smCapability = "7.0";
  variantName = "vllm-python311-cuda12_9-sm70-avx512bf16";
...
in
  python311Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA V100/Titan V (SM70) [CUDA 12.9, custom PyTorch AVX-512 BF16]";
      platforms = [ platform ];
    };
  })
