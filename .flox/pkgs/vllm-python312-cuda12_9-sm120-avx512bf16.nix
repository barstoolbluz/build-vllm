# vLLM 0.14.0 for NVIDIA Blackwell (SM120: RTX 5090, RTX PRO 6000) — AVX-512 BF16
...
let
  ...
  smCapability = "12.0";
  variantName = "vllm-python312-cuda12_9-sm120-avx512bf16";
...
in
  python312Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA RTX 5090/RTX PRO 6000 (SM120) [CUDA 12.9, custom PyTorch AVX-512 BF16]";
      platforms = [ platform ];
    };
  })
