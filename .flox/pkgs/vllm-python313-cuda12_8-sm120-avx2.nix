# vLLM 0.15.1 for NVIDIA Blackwell (SM120: RTX 5090, RTX PRO 6000) — AVX2
...
let
  ...
  smCapability = "12.0";
  variantName = "vllm-python313-cuda12_8-sm120-avx2";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA RTX 5090/RTX PRO 6000 (SM120) [CUDA 12.8, custom PyTorch AVX2]";
      platforms = [ platform ];
    };
  })
