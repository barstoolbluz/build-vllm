# vLLM 0.15.1 for NVIDIA Hopper (SM90: H100, H200, L40S) — AVX-512 BF16
...
let
  ...
  smCapability = "9.0";
  variantName = "vllm-python313-cuda12_9-sm90-avx512bf16";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA H100/H200/L40S (SM90) [CUDA 12.9, custom PyTorch AVX-512 BF16]";
      platforms = [ platform ];
    };
  })
