# vLLM 0.15.1 for NVIDIA Grace Hopper (SM90: GH200)
...
let
  ...
  smCapability = "9.0";
  variantName = "vllm-python312-cuda12_9-sm90-arm64";
  # ────────────────────────────────────────────────────────────────────
in
  nixpkgs_pinned.python312Packages.vllm.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA Grace Hopper GH200 (SM90) [CUDA 12.9]";
