# vLLM 0.14.0 for NVIDIA Hopper (SM90: H100 (Altra PCIe)) — ARMv8.2
...
let
  ...
  smCapability = "9.0";
  variantName = "vllm-python311-cuda12_8-sm90-armv8_2";
...
in
  python311Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA H100 Altra PCIe (SM90) [CUDA 12.8, custom PyTorch ARMv8.2]";
      platforms = [ platform ];
    };
  })
