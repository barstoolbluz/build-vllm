# vLLM 0.14.1 for NVIDIA Blackwell (SM120: RTX 5090, RTX PRO 6000) — AVX2
# CUDA 12.9 — Requires NVIDIA driver 560+
# Custom PyTorch 2.9.1 built from source (SM120 + AVX2)
{ pkgs ? import <nixpkgs> {} }:
let
  ...
  smCapability = "12.0";
  variantName = "vllm-python311-cuda12_9-sm120-avx2";
...
in
  python311Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.1 for NVIDIA RTX 5090/RTX PRO 6000 (SM120) [CUDA 12.9, custom PyTorch AVX2]";
      platforms = [ platform ];
    };
  })
