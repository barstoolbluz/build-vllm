# vLLM 0.15.1 for NVIDIA Grace Blackwell Ultra (SM103: GB300) — ARMv9
...
let
  ...
  smCapability = "10.3";
  variantName = "vllm-python313-cuda12_9-sm103-armv9";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA Grace Blackwell Ultra GB300 (SM103) [CUDA 12.9, custom PyTorch ARMv9]";
      platforms = [ platform ];
    };
  })
