# vLLM 0.14.0 for NVIDIA Ada Lovelace (SM89: RTX 4090, L4, L40) — AVX-512 VNNI
...
let
  ...
  smCapability = "8.9";
  variantName = "vllm-python312-cuda12_8-sm89-avx512vnni";
...
in
  python312Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA RTX 4090/L4/L40 (SM89) [CUDA 12.8, custom PyTorch AVX-512 VNNI]";
      platforms = [ platform ];
    };
  })
