# vLLM 0.15.1 for NVIDIA Hopper (SM90: H100, H200, L40S) — AVX-512 VNNI
...
let
  ...
  smCapability = "9.0";
  variantName = "vllm-python313-cuda12_8-sm90-avx512vnni";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA H100/H200/L40S (SM90) [CUDA 12.8, custom PyTorch AVX-512 VNNI]";
      platforms = [ platform ];
    };
  })
