# vLLM 0.14.0 for NVIDIA Ampere DC (SM80: A100 (Altra PCIe)) — ARMv8.2
...
let
  ...
  smCapability = "8.0";
  variantName = "vllm-python311-cuda12_9-sm80-armv8_2";
...
in
  python311Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA A100 Altra PCIe (SM80) [CUDA 12.9, custom PyTorch ARMv8.2]";
      platforms = [ platform ];
    };
  })
