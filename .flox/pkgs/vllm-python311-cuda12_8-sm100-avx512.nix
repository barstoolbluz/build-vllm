# vLLM 0.14.0 for NVIDIA Blackwell DC (SM100: B100, B200, GB200) — AVX-512
...
let
  ...
  smCapability = "10.0";
  variantName = "vllm-python311-cuda12_8-sm100-avx512";
...
in
  python311Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA B100/B200/GB200 (SM100) [CUDA 12.8, custom PyTorch AVX-512]";
      platforms = [ platform ];
    };
  })
