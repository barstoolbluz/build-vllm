# vLLM 0.15.1 for NVIDIA Ampere DC (SM80: A100, A30) — AVX-512
...
let
  ...
  smCapability = "8.0";
  variantName = "vllm-python313-cuda12_9-sm80-avx512";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA A100/A30 (SM80) [CUDA 12.9, custom PyTorch AVX-512]";
      platforms = [ platform ];
    };
  })
