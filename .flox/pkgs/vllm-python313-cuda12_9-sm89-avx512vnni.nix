# vLLM 0.15.1 for NVIDIA Ada Lovelace (SM89: RTX 4090, L4, L40) — AVX-512 VNNI
...
let
  ...
  smCapability = "8.9";
  variantName = "vllm-python313-cuda12_9-sm89-avx512vnni";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA RTX 4090/L4/L40 (SM89) [CUDA 12.9, custom PyTorch AVX-512 VNNI]";
      platforms = [ platform ];
    };
  })
