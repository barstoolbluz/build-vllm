# vLLM 0.15.1 for NVIDIA Blackwell Ultra (SM103: B300, GB300) — AVX2
...
let
  ...
  smCapability = "10.3";
  variantName = "vllm-python313-cuda12_9-sm103-avx2";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA B300/GB300 (SM103) [CUDA 12.9, custom PyTorch AVX2]";
      platforms = [ platform ];
    };
  })
