# vLLM 0.14.1 for NVIDIA Pascal (SM61: P40, GTX 1080 Ti) — AVX
...
let
  ...
  smCapability = "6.1";
  variantName = "vllm-python311-cuda12_9-sm61-avx";
...
in
  python311Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.1 for NVIDIA P40/GTX 1080 Ti (SM61) [CUDA 12.9, custom PyTorch AVX]";
      platforms = [ platform ];
    };
  })
