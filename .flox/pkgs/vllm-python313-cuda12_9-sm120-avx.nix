# vLLM 0.15.1 for NVIDIA Blackwell (SM120: RTX 5090, RTX PRO 6000) — AVX
...
let
  ...
  smCapability = "12.0";
  variantName = "vllm-python313-cuda12_9-sm120-avx";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA RTX 5090/RTX PRO 6000 (SM120) [CUDA 12.9, custom PyTorch AVX]";
      platforms = [ platform ];
    };
  })
