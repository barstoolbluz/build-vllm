# vLLM 0.15.1 for NVIDIA Ada Lovelace (SM89: RTX 4090, L4, L40) — AVX2
...
let
  ...
  smCapability = "8.9";
  variantName = "vllm-python313-cuda12_9-sm89-avx2";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA RTX 4090/L4/L40 (SM89) [CUDA 12.9, custom PyTorch AVX2]";
      platforms = [ platform ];
    };
  })
