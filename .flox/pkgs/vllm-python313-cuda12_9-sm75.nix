# vLLM 0.15.1 for NVIDIA Turing (SM75: T4, RTX 2080 Ti)
...
let
  ...
  smCapability = "7.5";
  variantName = "vllm-python313-cuda12_9-sm75";
...
in
  nixpkgs_pinned.python313Packages.vllm.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA T4/RTX 2080 Ti (SM75) [CUDA 12.9]";
