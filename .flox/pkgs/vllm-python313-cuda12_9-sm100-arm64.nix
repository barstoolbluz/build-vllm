# vLLM 0.15.1 for NVIDIA Grace Blackwell (SM100: GB200, GB300)
...
let
  ...
  smCapability = "10.0";
  variantName = "vllm-python313-cuda12_9-sm100-arm64";
...
in
  nixpkgs_pinned.python313Packages.vllm.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA Grace Blackwell GB200/GB300 (SM100) [CUDA 12.9]";
