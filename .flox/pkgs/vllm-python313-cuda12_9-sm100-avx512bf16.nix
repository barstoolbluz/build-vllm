# vLLM 0.15.1 for NVIDIA Blackwell DC (SM100: B100, B200, GB200) — AVX-512 BF16
...
let
  ...
  smCapability = "10.0";
  variantName = "vllm-python313-cuda12_9-sm100-avx512bf16";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA B100/B200/GB200 (SM100) [CUDA 12.9, custom PyTorch AVX-512 BF16]";
      platforms = [ platform ];
    };
  })
