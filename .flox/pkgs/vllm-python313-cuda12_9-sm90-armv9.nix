# vLLM 0.15.1 for NVIDIA Grace Hopper (SM90: GH200) — ARMv9
...
let
  ...
  smCapability = "9.0";
  variantName = "vllm-python313-cuda12_9-sm90-armv9";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA Grace Hopper GH200 (SM90) [CUDA 12.9, custom PyTorch ARMv9]";
      platforms = [ platform ];
    };
  })
