# vLLM 0.15.1 for NVIDIA Blackwell (SM120: RTX 5090, RTX PRO 6000)
...
let
  ...
  smCapability = "12.0";
  variantName = "vllm-python313-cuda12_9-sm120";
...
in
  nixpkgs_pinned.python313Packages.vllm.overrideAttrs (oldAttrs: {
    ...
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA RTX 5090/RTX PRO 6000 (SM120) [CUDA 12.9]";
