# vLLM 0.14.1 for NVIDIA Blackwell Ultra (SM103: B300, GB300) — AVX-512
...
let
  ...
  smCapability = "10.3";
  variantName = "vllm-python311-cuda12_9-sm103-avx512";
...
in
  python311Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.1 for NVIDIA B300/GB300 (SM103) [CUDA 12.9, custom PyTorch AVX-512]";
      platforms = [ platform ];
    };
  })
