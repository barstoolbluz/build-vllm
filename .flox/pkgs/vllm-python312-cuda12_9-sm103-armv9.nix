# vLLM 0.14.0 for NVIDIA Grace Blackwell Ultra (SM103: GB300) — ARMv9
# CUDA 12.9 — Requires NVIDIA driver 560+
# Custom PyTorch 2.9.1 built from source (SM103 + ARMv9)
{ pkgs ? import <nixpkgs> {} }:
let
  ...
  smCapability = "10.3";
  variantName = "vllm-python312-cuda12_9-sm103-armv9";
...
in
  python312Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA Grace Blackwell Ultra GB300 (SM103) [CUDA 12.9, custom PyTorch ARMv9]";
      platforms = [ platform ];
    };
  })
