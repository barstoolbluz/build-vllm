# vLLM 0.14.0 for NVIDIA Volta (SM70: V100, Titan V) — AVX-512 VNNI
...
let
  ...
  smCapability = "7.0";
  variantName = "vllm-python312-cuda12_8-sm70-avx512vnni";
...
in
  python312Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.14.0 for NVIDIA V100/Titan V (SM70) [CUDA 12.8, custom PyTorch AVX-512 VNNI]";
      platforms = [ platform ];
    };
  })
