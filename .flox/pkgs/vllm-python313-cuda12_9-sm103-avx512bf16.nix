# vLLM 0.15.1 for NVIDIA Blackwell Ultra (SM103: B300, GB300) — AVX-512 BF16
...
let
  ...
  smCapability = "10.3";
  variantName = "vllm-python313-cuda12_9-sm103-avx512bf16";
...
in
  python313Custom.pkgs.vllm.overrideAttrs (oldAttrs: {
    ...
    NIX_BUILD_CORES = 16;
    meta = oldAttrs.meta // {
      description = "vLLM 0.15.1 for NVIDIA B300/GB300 (SM103) [CUDA 12.9, custom PyTorch AVX-512 BF16]";
      platforms = [ platform ];
    };
  })
